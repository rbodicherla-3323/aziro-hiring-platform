...
(function () {
    ...
    const SCORE_STORAGE_KEY = `coding_suspicion_score_${SESSION_ID}`;
    const SCORE_THRESHOLD_LATCH_KEY = `coding_suspicion_latched_${SESSION_ID}`;
    ...
    function sendViolation(type, details = {}, useBeacon = false) {
        ...
        if (useBeacon && navigator.sendBeacon) {
            try {
                ...
                navigator.sendBeacon("/coding/proctoring/violation", blob);
                return;
            } catch (_) {
        ...
        fetch("/coding/proctoring/violation", {
            method: "POST",
